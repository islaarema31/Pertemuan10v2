            ...
            <div class="card" style="width: 24rem;">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('mahasiswas.update', $Mahasiswa->nim) }}" enctype="multipart/form-data" id="myForm">
                        ...
                        <div class="form-group">
                            <label for="img_mhs">Foto</label>
                            <input type="file" class="form-control" required="required" name="img_mhs" value="{{$Mahasiswa->img_mhs}}" placeholder="{{$Mahasiswa->img_mhs}}"></br>
                            <img src="{{asset('storage/'.$Mahasiswa->img_mhs)}}" alt="img_mhs" style="height: 100px; width: 100px; overflow: hidden; object-fit: cover;">
                        </div>
                        <div class="form-group">
