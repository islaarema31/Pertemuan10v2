...
<div class="container mt-5">
 ...
 <li class="list-group-item"><b>Foto: </b><img src="{{asset('storage/'.$Mahasiswa->img_mhs)}}" alt="img_mhs" style="height: 100px; width: 100px; overflow: hidden; object-fit: cover;"></li>
