...
class MahasiswaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->file('img_mhs')) {
            $image = $request->file('img_mhs')->store('images','public');
        }
        $mahasiswas->img_mhs = $image;
    ...
    public function update(Request $request, $nim)
    {
        ...
        $mahasiswas->nama = $request->get('nama');
        $mahasiswas->tgl_lahir = $request->get('tgl_lahir');
        if ($mahasiswas->img_mhs && file_exists(storage_path('app/public/' . $mahasiswas->img_mhs))) {
            Storage::delete('public/' . $mahasiswas->img_mhs);
        }
        $image = $request->file('img_mhs')->store('images', 'public');
        $mahasiswas->img_mhs = $image;
        $mahasiswas->jurusan = $request->get('jurusan');
